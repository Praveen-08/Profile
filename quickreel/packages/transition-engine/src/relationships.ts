...
export const ROOM_RELATIONSHIP_RULES: Partial<Record<RelationshipKey, TransitionType>> = {
  ...
  [key("DRONE", "EXTERIOR_FRONT")]: "MOTION_MATCH",
  [key("DRONE", "EXTERIOR_GENERAL")]: "MOTION_MATCH",
  ...
  [key("POOL", "DECK")]: "REFLECTION_WIPE",
  [key("DECK", "POOL")]: "REFLECTION_WIPE",
  [key("VIEWS", "TWILIGHT")]: "LUXURY_FADE",
  [key("KITCHEN", "LIVING_ROOM")]: "PERSPECTIVE_MATCH",
