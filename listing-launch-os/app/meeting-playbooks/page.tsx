        ...
        {playbooks.length === 0 ? (
          <Card className="mt-10 flex flex-col items-center gap-4 p-16 text-center">
            ...
            <p className="max-w-sm text-sm text-ink/60">
              Before your next appraisal or vendor pitch, create a playbook to walk in prepared — checklist, talking
              points, questions to ask, and a marketing package recommendation.
            </p>
